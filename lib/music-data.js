...
function buildDiscographyCopy({ title, artist, year, format, jeffRole, coverSource, note }) {
  ...
  return {
    intro: `${title} is a ${year} release by ${artist}. Jeff Berlin is credited as ${roleLabel}.`,
    snapshot: coverSource ? [`Artwork on this page is sourced from ${coverSource}.`] : [],
    caseStudy: note ? [note] : [],
    highlights: [],
    trackMoments: []
  };
...
function makeDiscographyEntry({
  ...
  return {
    ...
    cardBlurb:
      note || `Jeff Berlin is credited on ${artist}'s ${year} release ${title}.`,
    purchaseLink,
    trackListing,
    personnel,
    technicalCredits,
...
const discographyAlbums = [
  ...
  makeDiscographyEntry({
    ...
    year: "1979",
    format: "Studio Album",
    jeffRole: "Bass on two tracks",
    cover: "/music/credits/just-as-i-thought.jpg",
    coverSource: "Apple Music",
    cardBlurb:
      "David Sancious's first solo album after the Tone years shifts toward fusion, with Jeff Berlin and T.M. Stevens splitting bass duties around Sancious and Ernest Carter.",
    intro:
    ...
    highlights: [
      {
        title: "First record after Tone",
        body: "The album marks Sancious's first solo release after the David Sancious and Tone run, so it carries real transition weight."
      },
      {
        title: "Three-way bass picture",
        body: "Jeff Berlin, T.M. Stevens, and Sancious himself all handle bass on the album, which makes the rhythm design more interesting than a standard one-bassist session."
      },
      {
        title: "Eddy Offord production",
        body: "Offord's involvement ties the record to a more overtly progressive studio world even as Sancious pushes toward fusion."
      }
    ],
    trackMoments: [
      {
        title: "Run",
        body: "The opener announces the album's tighter fusion direction immediately rather than easing in through a long-form suite."
      },
      {
        title: "Suite (For the End of an Age)",
        body: "This is the album's long-form centerpiece and the clearest place where Sancious keeps one foot in progressive composition."
      },
      {
        title: "And Then She Said",
        body: "One of the record's sharpest fusion cuts, and a good place to hear the guitar-led bite that keeps the album from going soft."
      }
    ],
    trackListing: [
      "1. Run — 3:06",
    ...
    sources: [
      ...
      { label: "Apple Music", href: "https://music.apple.com/us/album/just-as-i-thought/1000013283" },
      { label: "JazzRockSoul discography", href: "https://jazzrocksoul.com/artists/david-sancious/" },
      { label: "Derek's Music Blog feature", href: "https://dereksmusicblog.com/2016/11/03/david-sancious-and-tone-true-stories-and-david-sancious-just-as-i-thought/" }
    ]
  }),
  makeDiscographyEntry({
    slug: "lifelike",
    ...
    year: "1980",
    format: "Live Album",
    jeffRole: "Bass on tracks 9 and 10",
    cover: "/music/credits/lifelike.jpg",
    coverSource: "Apple Music",
    cardBlurb:
      "A hybrid live Passport album stitched together from German concert dates, Montreux sets, and a pair of guest-heavy tracks with Jeff Berlin, Richard Tee, Steve Jordan, and David 'Fathead' Newman.",
    intro:
    ...
    highlights: [
      {
        title: "A stitched live album",
        body: "Lifelike is assembled from multiple venues and years, which means the personnel and production context shift across the record."
      },
      {
        title: "Jeff only on two tracks",
        body: "Berlin appears on 'Sambukada' and 'Stormy Monday Blues,' not across the full album, and the notes now make that explicit."
      },
      {
        title: "A different guest world",
        body: "Jeff's two tracks pull in Richard Tee, Steve Jordan, David 'Fathead' Newman, and Etta James, which gives them a very different identity from the core Passport performances."
      }
    ],
    trackMoments: [
      {
        title: "Sambukada",
        body: "Jeff's first track on the album pairs him with Richard Tee, Steve Jordan, Rafael Cruz, Sammy Figueroa, and David 'Fathead' Newman."
      },
      {
        title: "Stormy Monday Blues",
        body: "The second Jeff appearance adds Etta James and Brian Ray, turning the album momentarily into a much more overt blues-soul crossover setting."
      },
      {
        title: "Ataraxia",
        body: "A reminder of what the core Passport live band sounds like without the guest-heavy detour around Jeff's two tracks."
      }
    ],
    trackListing: [
      "1. Introduction — 0:19",
      ...
      "8. Jadoo — 7:38",
      "9. Sambukada — 7:51",
      "10. Stormy Monday Blues — 7:56",
      "11. Ataraxia — 8:28",
      "12. Dreamware — 5:37",
      "13. Alegria (Earthbound Version) — 8:00"
    ],
    personnel: [
    ...
    sources: [
      ...
      { label: "Sessiondays credits", href: "https://sessiondays.com/2023/05/03/1980-klaus-doldinger-passport-lifelike/" },
      { label: "Apple Music", href: "https://music.apple.com/us/album/lifelike/79652836" },
      { label: "Klaus Doldinger Wikipedia", href: "https://en.wikipedia.org/wiki/Klaus_Doldinger" }
    ]
  }),
  makeDiscographyEntry({
