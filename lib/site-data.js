const PAYPAL_ACCOUNT = "lumpyjazz@yahoo.com";

export const LESSON_PRICE = 150;

export function makePaypalLink(title, price, extraParams = {}) {
...
export const books = [
  {
    ...
    paypalHref: makePaypalLink("Jeff Berlin Bass Mastery Volume One", "39.95"),
    width: 2500,
    height: 3235
  },
  {
    ...
    paypalHref: makePaypalLink(
      "A Complete Reading Course For Beginners",
      "29.95"
    ),
    width: 1600,
    height: 1600
  },
  {
    ...
    paypalHref: makePaypalLink(
      "Book 2: Etudes in All Sharp and Flat Major Keys",
      "29.95"
    ),
    width: 1600,
    height: 1600
  },
  {
    ...
    paypalHref: makePaypalLink("Book 6: Academic Walking Lines", "29.95"),
    width: 932,
    height: 1170
  }
];
